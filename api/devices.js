...
module.exports = async function handler(req, res) {
    ...
    try {
        ...
        if (req.method === 'POST' && req.query.register === '1') {
            const { machineId, username, customerName, platform, osVersion, osBuild, userAgent, hostname } = req.body;
            ...
            if (existingDevice) {
                return res.status(409).json({ 
                    ...
                    device: {
                        ...
                        customerName: existingDevice.customerName || null,
                        registeredAt: existingDevice.createdAt
                    }
                });
            }
            // Register new device with username, customerName, and platform
            const newDevice = {
                machineId,
                username,
            ...
            return res.status(200).json({ 
                ...
                device: {
                    ...
                    customerName: newDevice.customerName || null,
